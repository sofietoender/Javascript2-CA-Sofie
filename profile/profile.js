...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const searchUrl = "https://v2.api.noroff.dev/social/posts/search"; // Endpoint for search
    const deleteUrl = "https://v2.api.noroff.dev/social/posts"; // Base URL for delete requests
    const profileName = localStorage.getItem('username'); // Get username from localStorage
    const profileUrl = `https://v2.api.noroff.dev/social/profiles/${profileName}`; // Endpoint for profile information
